    ...
    <AnimatePresence>
      <motion.div
        ...
        style={{
          ...
          width: "100%",
          height: "100%",
          backgroundColor: "#0a0a0a", // Глибокий чорний фон
      ...
      >
        ...
        >
            ...
            >
              ...
              <motion.div
                style={{
                  width: "0%",
                  height: "100%",
                  background: "linear-gradient(90deg, #ffffff, #e0e0e0)", // Біло-сірий градієнт
                  borderRadius: "3px",
          ...
          {/* Декоровані елементи - металеві/скляні */}
          <motion.div
            style={{
              position: "absolute",
              top: "-20px",
          ...
          {/* Додатковий елемент - сяючий ефект */}
          <motion.div
            style={{
              position: "absolute",
              bottom: "50px",
